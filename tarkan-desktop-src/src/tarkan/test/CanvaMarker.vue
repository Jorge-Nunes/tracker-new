  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      ...
      markersCluster = L.markerClusterGroup({
        // Você pode passar opções aqui, como `showCoverageOnHover`, `zoomToBoundsOnClick`, etc.
      });
      ...
      L.Canvas.include({
        _updateImg(layer) {
          ...
          if (layer.options.type === 'pointer') {
            ...
            const zFactor = Math.min(0.15, Math.max(0, (layer._map._zoom - 4) * 0.05));
